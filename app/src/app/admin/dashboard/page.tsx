          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Buscar..."
                className="bg-gray-600 border border-gray-500 rounded-lg pl-10 pr-4 py-2 text-white placeholder-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent w-64"
              />
            </div>
          </div>
        </div>
